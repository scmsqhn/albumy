...
class BaseConfig:
    ALBUMY_ADMIN_EMAIL = os.getenv('ALBUMY_ADMIN', '2364839934@qq.com')
    ...
    MAIL_USE_SSL = True
    # attention wrong 
    MAIL_PASSWORD = 'oycimssoihqkdhie'
    MAIL_USERNAME = '2364839934@qq.com'
    MAIL_DEFAULT_SENDER = ('Albumy Admin', MAIL_USERNAME)
    SECURITY_EMAIL_SENDER = '2364839934@qq.com'
    SECRET_KEY = os.getenv('SECRET_KEY', '33333333')
